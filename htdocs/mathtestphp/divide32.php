...
<div align="center">
  <p><font size="4" color=black><b>有餘數的直式除法測驗卷</b></font></p>
...
for($i=1; $i<=20; $i++){                  //此迴圈產生被除數與除數
  ...
  }while($divide1[$i-1] <= $divide2[$i-1] or $divide1[$i-1] % $divide2[$i-1] == 0);
};
...
for($k=1; $k<=20; $k++){ 
  ...
  echo "<td><font color=black>",$ans1[$k-1],"....",$ans2[$k-1],"</font></td>";
