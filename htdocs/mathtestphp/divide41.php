<html>
<head>
<title>整除的小數除法測驗卷</title>
<meta http-equiv="Content-Type" content="text/html; charset=big5">
</head>

<body bgcolor="#FFCCCC" text="#FF9966">
<div align="center">
  <p><font size="4" color=black><b>整除的小數除法測驗卷</b></font></p>
...
for($i=1; $i<=20; $i++){                  //此迴圈產生被除數與除數
  ...
  }while($divide1[$i-1] % $divide2[$i-1] != 0 or $divide1[$i-1]==1 or $divide2[$i-1]==1);
...
for($j=1; $j<=20; $j++){              //出考題的迴圈
  ...
  echo "<p align=left><font size=3 color=black>(",$j,") ",$divide1[$j-1]/pow(10,$dd12)," ÷ ",$divide2[$j-1]/pow(10,$dd22)," = <br><br><br><br><br><br><br></td>";
  $ans1[$j-1] = ($divide1[$j-1] / $divide2[$j-1]) / pow(10,$dd12-$dd22);       //求商
  echo "</td></font>";
